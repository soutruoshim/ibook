...
const double _kBottomMargin = 16.0;
...
BubbleBottomBarItem tab(String iconData, String tabName, BuildContext context) {
  return BubbleBottomBarItem(
      ...
      icon: cachedImage(iconData, height: 24, width: 24, color: Theme.of(context).textTheme.subtitle1!.color),
      activeIcon: cachedImage(iconData, height: 24, width: 24, color: primaryColor),
      title: Text(tabName, style: primaryTextStyle(color: primaryColor)));
}
